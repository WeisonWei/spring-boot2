...
public class CommonUtil {
     ...
     *
     */
    public static Student convertUser(StudentXo userXo) {
        Student user = new Student();
        user.setStudentName(userXo.getStudentName());
        user.setStudentPhone(userXo.getStudentPhone());
        return user;
    }
}
